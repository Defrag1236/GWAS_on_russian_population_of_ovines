...
sst = load.summary(files=file.names,
	...
	columnNames = c("MarkerName", "Allele1", "Allele2", "Freq1", "Effect", "StdErr", "n_total"), fixedN = NULL)

# do corrplot for sst$cor.pheno

for_order <- c(3, 6, 9, 12, 15, 18, 21, 2, 5, 8, 11, 14, 17, 20, 1, 4, 7, 10, 13, 16, 19, 24, 23, 22)
...
pdf("corrplot_for_24_metal_traits_multiabel.pdf", width=16, height=10)
...
save(sst, file="MV_sst_file_for_24_metal_traits.Rdata")