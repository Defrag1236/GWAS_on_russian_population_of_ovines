...
for (n in (1:11)) {
	...
	x <- paste("ped_6d_", n, "_trait.map", sep="") 
...
for (n in (1:11)) {
	...
	x <- paste("ped_42d_", n, "_trait.map", sep="") 
...
for (n in (1:11)) {
	...
	x <- paste("ped_3m_", n, "_trait.map", sep="") 
...
setwd("/home/common/projects/ovine_selection/GWAS_on_russian_population_of_ovines/data/plink_files/ped_6d")
...
setwd("/home/common/projects/ovine_selection/GWAS_on_russian_population_of_ovines/data/plink_files/ped_42d")
