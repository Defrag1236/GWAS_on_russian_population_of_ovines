...
# path to function
source("/home/common/projects/ovine_selection/GWAS_on_russian_population_of_ovines/zlobin_src/GWAS_on_russian_population_of_ovines/2021/05_regional_association_plots_on_pc_results/05b_plot_function.R")
...
for (i in 1:nrow(new_snps)) {
  ...
  snp       <- new_snps[i,1]
  # title of plot
  locusname <- paste("SNP", snp,"for pc_2", sep=" ")
  # locus file (e.g. output of "building_locus_file.r")
  locus     <- read.table(paste("/home/common/projects/ovine_selection/GWAS_on_russian_population_of_ovines/2021/data/for_regional_association_plot/locus_table_", snp, ".txt", sep=""), header=T, stringsAsFactors=F)
  # known genes path
	known_genes_path <- "na"	
  # path for plot
  pfad_ausgabe <- paste("/home/common/projects/ovine_selection/GWAS_on_russian_population_of_ovines/2021/results/plots/regional_association_plots/assocplot_LDregions_", snp,".pdf", sep="")
