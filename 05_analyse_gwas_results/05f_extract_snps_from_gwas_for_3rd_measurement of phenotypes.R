### extract snps from gwas for 3rd measurement of phenotypes ###
...
for (n in (1:11)) {
	...
	trait_name <- as.matrix(pheno_3m_key[n,2])
...
save(trait_list_snps, file="significant_snps_for_3m_measurement_of_phenotypes.Rdata")
save(trait_list_top_snps, file="3m_top5_snps.Rdata")