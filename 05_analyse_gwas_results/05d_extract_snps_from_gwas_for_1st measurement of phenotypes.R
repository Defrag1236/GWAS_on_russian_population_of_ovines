...
for (n in (1:11)) {
	...
	trait_name <- as.matrix(pheno_6d_key[n,2])
...
save(trait_list_snps, file="significant_snps_for_6d_measurement_of_phenotypes.Rdata")
save(trait_list_top_snps, file="6d_top5_snps.Rdata")