### count lambda for 1st measurement of phenotypes ###
...
lambda_table[,1] <- as.matrix(pheno_6d_key[,2])
...
fwrite(lambda_table, "lambda_table_6d.txt", col.names=F, row.names=F, quote=F, sep="\t")